...
<?php
	...
	// VIEW TEACHER
	// Check if the teacher_id is set
	...
	if(isset($_POST['submit'])){
		...
		$req_fields = array('teacher_id', 'password', 'password_confirm');
		...
		if(empty($errors)){
			...
			if($result){
				header('Location: teacher-details.php?user_password_edit=true');
			}else{
		...
		<div class="row">
			<div class="col-sm-12 col-md-6 mx-auto">
				<div class="card card-signin my-5">
					...
					<div class="card-body">
						<h3 class="card-title text-center">Update Teacher Password</h3>
